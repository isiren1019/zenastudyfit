...
def html_page(city, gu, dong, grade, subject, slug):
  ...
  <div class="bd" style="font-size:.72rem;color:#9b6cc0">{desc}</div>
    ...
    related_banner_html += """<a href="/self-study/" style="background:#faf5ff;border:1px solid #d4b8f5;border-radius:10px;padding:12px 8px;text-align:center;text-decoration:none;display:block;transition:all .15s" onmouseover="this.style.background='#510580';this.querySelector('.bs').style.color='white';this.querySelector('.bd').style.color='rgba(255,255,255,0.7)'" onmouseout="this.style.background='#faf5ff';this.querySelector('.bs').style.color='#510580';this.querySelector('.bd').style.color='#9b6cc0'">
  <div class="bs" style="font-size:.82rem;font-weight:700;color:#510580;margin-bottom:3px">공부 습관 완성</div>
  <div class="bd" style="font-size:.72rem;color:#9b6cc0">자기주도학습 코칭</div>
</a>"""
    related_banner_html += """<a href="/coding/" style="background:#faf5ff;border:1px solid #d4b8f5;border-radius:10px;padding:12px 8px;text-align:center;text-decoration:none;display:block;transition:all .15s" onmouseover="this.style.background='#510580';this.querySelector('.bs').style.color='white';this.querySelector('.bd').style.color='rgba(255,255,255,0.7)'" onmouseout="this.style.background='#faf5ff';this.querySelector('.bs').style.color='#510580';this.querySelector('.bd').style.color='#9b6cc0'">
  <div class="bs" style="font-size:.82rem;font-weight:700;color:#510580;margin-bottom:3px">AI 시대 코딩 과외</div>
  ...
  <div style="font-size:.85rem;color:#c9a3e8;flex-shrink:0">→</div>
    ...
    related_list_html += """<a href="/self-study/" style="display:flex;align-items:center;justify-content:space-between;padding:12px 16px;border-bottom:1px solid #f0e6fc;text-decoration:none;background:white;transition:background .12s" onmouseover="this.style.background='#faf5ff'" onmouseout="this.style.background='white'">
  <div style="display:flex;align-items:center;gap:10px">
    <div style="width:30px;height:30px;border-radius:50%;background:#f0e6fc;display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0">📋</div>
    <div>
      <div style="font-size:.85rem;font-weight:700;color:#370558">공부 습관 완성 과외</div>
      <div style="font-size:.72rem;color:#9b6cc0;margin-top:2px">과목별 공부법 · 플랜 관리 · 자기주도학습</div>
    </div>
  </div>
  <div style="font-size:.85rem;color:#c9a3e8;flex-shrink:0">→</div>
</a>"""
    related_list_html += """<a href="/coding/" style="display:flex;align-items:center;justify-content:space-between;padding:12px 16px;text-decoration:none;background:white;transition:background .12s" onmouseover="this.style.background='#faf5ff'" onmouseout="this.style.background='white'">
  <div style="display:flex;align-items:center;gap:10px">
    <div style="width:30px;height:30px;border-radius:50%;background:#f0e6fc;display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0">💻</div>
    <div>
      <div style="font-size:.85rem;font-weight:700;color:#370558">AI 시대 코딩 과외</div>
      <div style="font-size:.72rem;color:#9b6cc0;margin-top:2px">자바스크립트 · 파이썬을 통한 컴퓨팅 사고력</div>
    </div>
  </div>
  <div style="font-size:.85rem;color:#c9a3e8;flex-shrink:0">→</div>
</a>"""
...
def html_coding():
    CODING_FORM_URL = "https://naver.me/GT40B8Ah"
    return f"""<!DOCTYPE html>
<html lang="ko">
<head>
  <meta charset="UTF-8">
  ...
  <meta name="description" content="초·중·고 1:1 맞춤 화상 코딩 수업. 자바스크립트 앱창작부터 파이썬 데이터사이언스까지 단계별 커리큘럼.">
  <link rel="icon" type="image/x-icon" href="/favicon.ico">
  <link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png">
  <link rel="apple-touch-icon" href="/apple-touch-icon.png">
  <meta property="og:type" content="website">
  <meta property="og:title" content="코딩 교육 | {SITE_NAME}">
  <meta property="og:description" content="초·중·고 1:1 맞춤 화상 코딩 수업. 자바스크립트부터 파이썬까지.">
...
<div class="wrap">
  ...
  <section class="sec">
    ...
    <div class="feature-steps">
      ...
      <div class="step-item"><div class="step-num">3</div><div><div class="step-title">차별화된 시스템을 통한 자기주도학습 습관</div><div class="step-desc">학습 단계 종료 후 테스트를 통해 부족한 부분을 보완하고, 매 시간 수업 피드백을 통해 학습 상황과 성취도를 파악하고 소통할 수 있습니다.</div></div></div>
  ...
  <section class="sec">
    ...
    <div id="curr-js" class="curr-list">
      <div class="curr-item"><div class="curr-item-header"><div class="curr-icon">L1</div><div><div class="curr-level">Lv.1 · 프로그래밍 개념 입문</div><div class="curr-title">코딩의 시작, 텍스트 언어로 앱 만들기</div><div class="curr-desc">코딩이 필요한 이유를 이해하고, 자신의 생각을 텍스트 언어로 표현하는 방법을 배워요. 모바일에서도 실행할 수 있는 다양한 주제의 앱을 직접 만들면서 기초 프로그래밍 개념을 익혀요.</div></div></div><div class="curr-tags"><span class="curr-tag">API 사용(기본)</span><span class="curr-tag">API 사용(심화)</span></div></div>
      <div class="curr-item"><div class="curr-item-header"><div class="curr-icon">L2</div><div><div class="curr-level">Lv.2 · 프로그래밍 개념 기초</div><div class="curr-title">주요 개념으로 다양한 앱 스스로 제작</div><div class="curr-desc">순차, 반복, 선택 구조와 같은 주요 개념을 정확하게 이해하고 다양한 방법으로 문제를 해결해요.</div></div></div><div class="curr-tags"><span class="curr-tag">변수, 조건</span><span class="curr-tag">변수, 조건(심화)</span><span class="curr-tag">복제, 함수, 배열(기본)</span></div></div>
      <div class="curr-item"><div class="curr-item-header"><div class="curr-icon">L3</div><div><div class="curr-level">Lv.3 · 프로그래밍 개념 심화</div><div class="curr-title">복잡한 앱을 효율적인 방법으로 제작</div><div class="curr-desc">복제, 함수, 배열 등 심화 개념을 활용해 같은 문제를 효율적인 방법으로 해결해요.</div></div></div><div class="curr-tags"><span class="curr-tag">복제, 함수, 배열, 반복(심화)</span><span class="curr-tag">조건, 복제, 함수, 반복(응용)</span></div></div>
      <div class="curr-item"><div class="curr-item-header"><div class="curr-icon">L4</div><div><div class="curr-level">Lv.4 · 프로그래밍 응용 기초</div><div class="curr-title">실제 개발 방법과 알고리즘으로 아이디어 표현</div><div class="curr-desc">실제 개발에서 사용되는 다양한 프로그래밍 방법과 알고리즘을 익혀 아이디어를 효율적으로 표현해요.</div></div></div><div class="curr-tags"><span class="curr-tag">변수, 조건, 함수, 반복(응용)</span><span class="curr-tag">변수, 조건, 배열(심화)</span></div></div>
      <div class="curr-item"><div class="curr-item-header"><div class="curr-icon">L5</div><div><div class="curr-level">Lv.5 · 프로그래밍 응용 심화</div><div class="curr-title">심화 개념 활용, 나만의 앱 완성</div><div class="curr-desc">프로그래밍 심화 개념이 복잡하게 얽혀있는 앱을 제작하고 다양한 알고리즘을 활용해 아이디어를 표현해요.</div></div></div><div class="curr-tags"><span class="curr-tag">함수, 반복, 조건(심화)</span><span class="curr-tag">함수, 복제, 변수(심화)</span></div></div>
    </div>
    <div id="curr-py" class="curr-list" style="display:none">
      <div class="curr-item"><div class="curr-item-header"><div class="curr-icon">L1</div><div><div class="curr-level">Lv.1 · 데이터 분석 기초</div><div class="curr-title">파이썬 기초 문법으로 데이터 분석력 키우기</div><div class="curr-desc">변수, 자료형, 제어문 등 파이썬 기초 문법을 배우며 데이터를 수집하고 가공하는 방법을 익혀요.</div></div></div><div class="curr-tags"><span class="curr-tag">변수, 자료형, 제어문, 연산자</span><span class="curr-tag">자료형(딕셔너리, 튜플, 집합)</span></div></div>
      <div class="curr-item"><div class="curr-item-header"><div class="curr-icon">L2</div><div><div class="curr-level">Lv.2 · 데이터 분석 심화</div><div class="curr-title">함수와 모듈로 프로그래밍 효율성 높이기</div><div class="curr-desc">사용자 함수를 정의하고 모듈을 활용해 복잡한 문제를 효율적으로 해결해요.</div></div></div><div class="curr-tags"><span class="curr-tag">사용자 정의 함수, 반복 흐름 제어</span><span class="curr-tag">모듈, 연산(교체, 비트)</span></div></div>
      <div class="curr-item"><div class="curr-item-header"><div class="curr-icon">L3</div><div><div class="curr-level">Lv.3 · 자료구조 기초</div><div class="curr-title">클래스와 자료구조·알고리즘 구현</div><div class="curr-desc">클래스, 스택, 큐, 그래프 자료구조를 익히고 알고리즘을 구현해요.</div></div></div><div class="curr-tags"><span class="curr-tag">클래스, 모듈, 해시함수</span><span class="curr-tag">자료구조&알고리즘, 스택, 큐</span></div></div>
      <div class="curr-item"><div class="curr-item-header"><div class="curr-icon">L4</div><div><div class="curr-level">Lv.4 · 자료구조 심화</div><div class="curr-title">재귀·정렬·탐색 알고리즘으로 효율적 프로그래밍</div><div class="curr-desc">재귀, 정렬, 탐색 알고리즘 원리를 이해하고 구현하며 심화 개념을 다져요.</div></div></div><div class="curr-tags"><span class="curr-tag">트리, 트리탐색, 재귀&선택 정렬</span><span class="curr-tag">DFS 탐색, Convex hull 알고리즘</span></div></div>
      <div class="curr-item"><div class="curr-item-header"><div class="curr-icon">L5</div><div><div class="curr-level">Lv.5 · 인공지능 기초</div><div class="curr-title">빅데이터·AI 기초, 데이터 시각화·분석</div><div class="curr-desc">파이썬 라이브러리로 데이터를 시각화·분석하고 인공지능의 기초 개념을 이해해요.</div></div></div><div class="curr-tags"><span class="curr-tag">데이터 시각화 및 분석</span><span class="curr-tag">인공지능, 지도학습, 비지도학습</span></div></div>
    </div>
  </section>
</div>
<div class="cta-sec">
...
<head>
  ...
  <meta name="description" content="초등 5학년~고등 1:1 화상 자기주도학습 코칭. 해빗·스터디·커리어·감정 코칭으로 공부 방법부터 바꿉니다.">
  <link rel="icon" type="image/x-icon" href="/favicon.ico">
  <link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png">
  <link rel="apple-touch-icon" href="/apple-touch-icon.png">
  <meta property="og:type" content="website">
...
<div class="wrap">
  ...
  <section class="sec">
    ...
    <div class="process-item"><div class="process-num">1</div><div><div class="process-title">스타트체크 — 학습 현황 진단</div><div class="process-desc">학습 습관, 공부 방법, 정서 상태를 종합적으로 진단하고 맞춤 코칭 커리큘럼을 설계합니다.</div></div></div>
    <div class="process-item"><div class="process-num">2</div><div><div class="process-title">목표 설정 — 단기/장기 플랜 수립</div><div class="process-desc">현재 상태와 목표를 함께 확인하고 현실적인 단기·장기 학습 계획을 세웁니다.</div></div></div>
    <div class="process-item"><div class="process-num">3</div><div><div class="process-title">1:1 화상 코칭 수업 진행</div><div class="process-desc">매주 1회 60분, 전담 코치와 1:1로 진행합니다. 해빗·스터디·커리어·감정 코칭을 상황에 맞게 구성합니다.</div></div></div>
    <div class="process-item"><div class="process-num">4</div><div><div class="process-title">피드백 & 성장 관리</div><div class="process-desc">매 수업 후 학부모님께 피드백을 제공하고 플래너 점검과 습관 트래킹으로 꾸준한 성장을 확인합니다.</div></div></div>
  </section>
  <hr class="divider">
  <section class="sec">
    <div class="sec-label">수업 후기</div>
    ...
    <div class="review-grid">
      ...
      <div class="review-card"><div class="review-quote">계획은 세워도 실천할 줄을 몰랐는데</div><div class="review-desc">코치님이 지속적으로 소통을 해 주시니까 학교 숙제며, 학원 숙제며 이제 곧잘 하고 있어요.</div><div class="review-author">주경O 회원 학부모</div></div>
