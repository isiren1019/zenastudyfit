...
def html_page(city, gu, dong, grade, subject, slug):
  ...
  <div class="bd" style="font-size:.72rem;color:#9b6cc0">{desc}</div>
    ...
    # 자기주도학습 버튼
    related_banner_html += f"""<a href="/self-study/" style="background:white;border:1px solid #e8d6f5;border-radius:10px;padding:12px 8px;text-align:center;text-decoration:none;display:block;transition:all .15s" onmouseover="this.style.background='#510580';this.querySelector('.bs').style.color='white';this.querySelector('.bd').style.color='rgba(255,255,255,0.7)'" onmouseout="this.style.background='white';this.querySelector('.bs').style.color='#370558';this.querySelector('.bd').style.color='#9b6cc0'">
  <div class="bs" style="font-size:.82rem;font-weight:700;color:#370558;margin-bottom:3px">공부 습관 완성</div>
  <div class="bd" style="font-size:.72rem;color:#9b6cc0">자기주도학습 코칭</div>
</a>"""
    # 코딩 버튼
    related_banner_html += f"""<a href="/coding/" style="background:white;border:1px solid #e8d6f5;border-radius:10px;padding:12px 8px;text-align:center;text-decoration:none;display:block;transition:all .15s" onmouseover="this.style.background='#510580';this.querySelector('.bs').style.color='white';this.querySelector('.bd').style.color='rgba(255,255,255,0.7)'" onmouseout="this.style.background='white';this.querySelector('.bs').style.color='#370558';this.querySelector('.bd').style.color='#9b6cc0'">
  <div class="bs" style="font-size:.82rem;font-weight:700;color:#370558;margin-bottom:3px">AI 시대 코딩 과외</div>
  ...
  <div style="font-size:.85rem;color:#c9a3e8;flex-shrink:0">→</div>
    ...
    # 자기주도학습 리스트 항목
    related_list_html += f"""<a href="/self-study/" style="display:flex;align-items:center;justify-content:space-between;padding:12px 16px;border-bottom:1px solid #f0e6fc;text-decoration:none;background:white;transition:background .12s" onmouseover="this.style.background='#faf5ff'" onmouseout="this.style.background='white'">
  <div style="display:flex;align-items:center;gap:10px">
  ...
  <div style="font-size:.85rem;color:#c9a3e8;flex-shrink:0">→</div>
    ...
    # 코딩 리스트 항목
    related_list_html += f"""<a href="/coding/" style="display:flex;align-items:center;justify-content:space-between;padding:12px 16px;text-decoration:none;background:white;transition:background .12s" onmouseover="this.style.background='#faf5ff'" onmouseout="this.style.background='white'">
  <div style="display:flex;align-items:center;gap:10px">
    <div style="width:30px;height:30px;border-radius:50%;background:#f0e6fc;display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0">💻</div>
    <div>
