...
export const SUBJECT_HUB_DATA = {
  "english": {
    ...
    categories: [
      { key: "grade", name: "학년별 학습 로드맵", count: 14, newUntil: "2026-01-01", highlight: true,
      ...
      { key: "habit", name: "학습 습관 & 공부법", count: 5, newUntil: "2026-01-01",
        items: [["timing","영어 공부 시간 관리"],["notes","오답노트 작성법"],["self","자기주도 영어 학습"],["routine","영어 학습 루틴"],["slump","영어 슬럼프 극복법"]] },
      { key: "perform", name: "수행평가 & 서술형", count: 2, newUntil: "2026-01-01",
      ...
      { key: "writing", name: "작문 (Writing)", count: 6, newUntil: "2026-06-19",
  ...
  "math": {
    ...
    categories: [
      ...
      { key: "perform", name: "수행평가", count: 2, newUntil: "2026-01-01",
  ...
  "social": {
    ...
    categories: [
      ...
      { key: "perform", name: "수행평가 & 서술형", count: 3, newUntil: "2026-01-01",
